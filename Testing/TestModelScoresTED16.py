...
raw_dataset = load_dataset('ted_talks_iwslt', language_pair=('en', 'pl'), year='2016', split='test').flatten()
...
evaluate_models(en_pl_dataset, pl_en_dataset, 'results-ted-16.txt')
