...
raw_dataset = load_dataset('Helsinki-NLP/tatoeba_mt', 'eng-pol', split='dev').select(range(4000))
...
evaluate_models(en_pl_dataset, pl_en_dataset, 'results-tatoeba-dev.txt')
